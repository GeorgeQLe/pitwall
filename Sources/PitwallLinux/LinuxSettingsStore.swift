...
public actor LinuxSettingsStore: SettingsStorage {
    ...
    public func loadPreferences() async -> UserPreferences {
        guard
            ...
            let stored = try? decoder.decode(StoredLinuxUserPreferences.self, from: data)
        else {
    ...
    public func savePreferences(_ preferences: UserPreferences) async throws {
        ...
        let stored = StoredLinuxUserPreferences(preferences)
