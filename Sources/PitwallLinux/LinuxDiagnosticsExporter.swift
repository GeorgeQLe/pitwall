...
public struct LinuxDiagnosticsInput: Sendable {
...
public struct LinuxDiagnosticsExporter: Sendable {
    public static let defaultFileName = "pitwall-diagnostics.json"

    private let root: LinuxStorageRoot
    ...
    public func build(input: LinuxDiagnosticsInput) -> DiagnosticsExport {
    ...
    @discardableResult
    public func export(input: LinuxDiagnosticsInput) throws -> URL {
