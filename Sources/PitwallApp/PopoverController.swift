...
final class PopoverController: NSObject, NSPopoverDelegate, NSWindowDelegate {
    ...
    func presentOnboardingPanel(
        ...
        let wizard = OnboardingWizardView(
            ...
            onStartCodexChatGPTLogin: onStartCodexChatGPTLogin,
            onCurrentCodexChatGPTLoginState: onCurrentCodexChatGPTLoginState,
            onRetryCodexChatGPTLoginBrowser: onRetryCodexChatGPTLoginBrowser,
            onCancelCodexChatGPTLogin: onCancelCodexChatGPTLogin,
