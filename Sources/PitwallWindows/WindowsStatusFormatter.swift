...
/// Portable, AppKit-free formatter used by the Windows tray and provider cards.
/// Mirrors the behavior of `MenuBarStatusFormatter` in `PitwallAppSupport` but
/// lives in the Windows shell so it can evolve independently per the
/// cross-platform architecture doc.
public struct WindowsStatusFormatter: Sendable {
    public init() {}
