...
/// Structured model the Windows tray uses to render a provider card row.
/// The actual Win32 / WinUI rendering code consumes this without having to
/// re-derive any business logic.
public struct WindowsProviderCardViewModel: Equatable, Sendable {
...
public struct WindowsTrayMenuViewModel: Equatable, Sendable {
    public var tooltip: String
    public var providerCards: [WindowsProviderCardViewModel]
    public var settingsAvailable: Bool
    public var diagnosticsExportAvailable: Bool

    public init(
        tooltip: String,
        providerCards: [WindowsProviderCardViewModel],
...
public struct WindowsTrayMenuBuilder: Sendable {
    private let formatter: WindowsStatusFormatter

    public init(formatter: WindowsStatusFormatter = WindowsStatusFormatter()) {
    ...
    public func build(
        ...
        return WindowsTrayMenuViewModel(
            tooltip: tooltip,
            providerCards: cards
        )
    }
